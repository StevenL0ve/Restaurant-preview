...
export const VENUES: Record<Venue, { name: string; short: string; icon: string; blurb: string; logo?: string; hours?: string }> = {
  ...
  cafe: { name: "Common Grounds Café", short: "Coffee Shop", icon: "☕️", blurb: "Small-batch coffee & fresh bakes. Earn a punch on every drink.", logo: "/brand/logo.png", hours: "Tue–Sun 7am–3pm · Fri & Sat 5–9pm" },
